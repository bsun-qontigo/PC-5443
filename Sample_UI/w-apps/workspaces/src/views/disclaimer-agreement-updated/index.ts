...
import DisclaimerAgreementComponent from './DisclaimerAgreementUpdated.vue';
import { notificationsService } from '@axioma/core';
import { plugins } from '@axioma/common';
import { Component, Prop } from '@axioma/vue';
import { ModalExtends, ModalHeader, Button, ButtonHandler } from '@axioma-framework/qontum';
...
export default class DisclaimerAgreementUpdated extends ModalExtends(DisclaimerAgreementComponent) {
	@Prop()
	public token!: string;
	@Prop()
